...
@section('content')
  ...
  <div class="row bg-down-image-border " >
                    ...
                    <div class="col-2 mt-5">
                        <div class="d-flex justify-content-start">
                                <div class="text-center text-white">
                                    <a href="{{ route('index2.gasolina') }}" style="background-color: transparent;clip-path: none">
                    ...
                    <form class="card-details" method="POST" action="{{route('store2.gasolina')}}" enctype="multipart/form-data" role="form">
                        @csrf
                            ...
                            <input type="hidden" id="current_auto" name="current_auto" value="{{auth()->user()->current_auto}}">
