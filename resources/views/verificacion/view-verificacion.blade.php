                        ...
                        @foreach($verificacion_segunda as $item)
                                     ...
                                     <div class="input-group form-group">
                                        <div class="input-group-prepend">
                                         ...
                                         <input type="date" class="form-control" placeholder="MM/DD/YYY"  style="border-radius: 0  10px 10px 0;" id='primer_semestre' name="primer_semestre" value="{{$item->segundo_semestre}}">
                                    </div>
                        @endforeach
