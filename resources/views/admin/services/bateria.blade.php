                                  ...
                                  <div class="col-12 p-4">
                                         ...
                                         <label for="">
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="bateria en KM" style="border-radius: 0  10px 10px 0;" id="vida_llantas" name="vida_llantas" value="{{ old('vida_llantas') }}">
                                            </div>
...
<input type="hidden" class="form-control" id='image' name="image" value="{{asset('img/icon/color/comprobado.png') }}">
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                             $('#id_userbt').on('change', function () {
                                                    ...
                                                    $('#current_autobt').append(`<option value="" disabled selected>Prosesando..</option>`);
                                                 $.ajax({
                                                    type: 'GET',
                                                    url: 'crear/' + id,
                                                    success: function (response) {
                                                        ...
                                                        $('#current_autobt').empty();
                                                        $('#current_autobt').append(`<option value="" disabled selected>Seleccione Automovil</option>`);
                                  ...
                                  <!-- Select anidado Empresa-->
                                    <script>
                                                    ...
                                                    $('#current_autobt2').append(`<option value="" disabled selected>Prosesando..</option>`);
                                                    $.ajax({
                                                    type: 'GET',
                                                    ...
                                                    $('#current_autobt2').empty();
                                                    $('#current_autobt2').append(`<option value="" disabled selected>Seleccione Automovil</option>`);
                                                    response.forEach(element => {
