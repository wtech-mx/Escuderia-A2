                              <form method="POST" action="{{route('store_servicio.servicio')}}" enctype="multipart/form-data" role="form">
                                 @csrf
                                    ...
                                    <div class="tab-content p-4" id="pills-tabContent">
                                      ...
                                      <div class="tab-pane fade show active mr-4 ml-4" id="pills-Empresa-bateria" role="tabpanel" aria-labelledby="pills-Empresa-bateria-tab">
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <select class="form-control" id="current_autobt2" name="current_autobt2">
                                      ...
                                      <div class="tab-pane fade mr-4 ml-4" id="pills-Usuario-bateria" role="tabpanel" aria-labelledby="pills-Usuario-bateria-tab">
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <select class="form-control" id="current_autobt" name="current_autobt" value="{{ old('current_autobt') }}">
                                              <option value="">Seleccione auto</option>
                                            </select>
                                        </div>
                                  ...
                                  <div class="col-12 p-4">
                                        ...
                                        <input type="button" class="proveedor7" id="proveedor7" value="Agregar proveedor">
                                        <div id="nuevo-form7"></div>
                                        ...
                                        <div class="input-group form-group">
                                         ...
                                         <hr>
                                         <label for="">
                                             <p class="text-white"><strong>Vida de bateria en KM</strong></p>
                                         </label>
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="vida bateria" style="border-radius: 0  10px 10px 0;" id="vida_llantas" name="vida_llantas" value="{{ old('vida_llantas') }}">
                                            </div>
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                             $('#id_userbt').on('change', function () {
                                                    ...
                                                    $('#current_autobt').empty();
                                                    $('#current_autobt').append(`<option value="" disabled selected>Procesando..</option>`);
                                                 $.ajax({
                                                    type: 'GET',
                                                    url: 'crear/' + id,
                                                    success: function (response) {
                                                        ...
                                                        $('#current_autobt').empty();
                                                        $('#current_autobt').append(`<option value="" disabled selected>Seleccione Autom&oacute;vil</option>`);
                                                        response.forEach(element => {
                                                            $('#current_autobt').append(`<option value="${element['id']}">${element['submarca']}</option>`);
                                                        });
                                                    }
                                                });
                                            });
                                  ...
                                  <!-- Select anidado Empresa-->
                                    <script>
                                                    $(document).ready(function () {
                                                    $('#id_empresabt').on('change', function () {
                                                    let id = $(this).val();
                                                    //id_empresa no esta en la tabla de automovil
                                                    $('#current_autobt2').empty();
                                                    $('#current_autobt2').append(`<option value="" disabled selected>Procesando..</option>`);
                                                    $.ajax({
                                                    type: 'GET',
                                                    ...
                                                    $('#current_autobt2').empty();
                                                    $('#current_autobt2').append(`<option value="" disabled selected>Seleccione Autom&oacute;vil</option>`);
                                                    response.forEach(element => {
                                                        $('#current_autobt2').append(`<option value="${element['id']}">${element['submarca']}</option>`);
                                                        });
                                                    }
                                                });
                                            });
...
<script>
    $(document).ready(function () {
        $('#id_empresabt').on('change', function () {
            let id = $(this).val();
            //id_empresabt no esta en la tabla de automovil
            $('#current_autobt2').empty();
            $('#current_autobt2').append(`<option value="" disabled selected>Procesando..</option>`);
                $.ajax({
                type: 'GET',
                ...
                var response = JSON.parse(response);
                console.log(response);
                //trae los automoviles relacionados con el id_empresabt
                $('#current_autobt2').empty();
                $('#current_autobt2').append(`<option value="" disabled selected>Seleccione Autom&oacute;vil</option>`);
                response.forEach(element => {
                    $('#current_autobt2').append(`<option value="${element['id']}">${element['submarca']}</option>`);
                                ...
                                <script>
                                    var agregar7 = document.getElementById('proveedor7');
                                    var contenedor7 = document.getElementById('nuevo-form7');
                                    var contador = 0;

                                    agregar7.addEventListener('click', function(){
                                        contador++;
                                        var _form7 = '<hr><label class="subtitle-form-servi">Proveedor '+ contador +'</label>' +
