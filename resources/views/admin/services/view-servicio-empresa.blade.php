    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="text-align:center">Detalles Del Servicio /
                <strong>{{ $item->UserEmpresa->name }} - {{ $servicio }}</strong></h5>
