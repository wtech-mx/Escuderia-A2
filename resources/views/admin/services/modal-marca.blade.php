                                ...
                                <div class="col-12 ">
                                    <p class="text-center">
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nombre de la Marca" style="border-radius: 0  10px 10px 0;background-color: #050F55;color: #FFFFFF" id='datetimepicker1'>
                                            </div>
                                    </p>
