                        ...
                        <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" data-interval="60000">
                              <div class="carousel-inner">
                                ...
                                <div class="carousel-item active">
                                  ...
                                  <div class="row">
                                    @foreach ($mecanica_llantas_empresa as $item)
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_banda_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_freno_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_aceite_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_afinacion_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_amortiguadores_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
                                ...
                                <div class="carousel-item ">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            @foreach ($mecanica_bateria_empresa as $item)
                                                <div class="col-12 mt-4">
                                                    <div class="card card-slide-garaje" >
                                                      <div class="card-body p-2" >
