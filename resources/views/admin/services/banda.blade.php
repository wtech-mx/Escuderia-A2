                                     ...
                                     <div class="d-flex justify-content-center">.
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                          <li class="nav-item bg-white">
                                            <a class="nav-link active" id="pills-Empresa-banda-tab" data-toggle="pill" href="#pills-Empresa-banda" role="tab" aria-controls="pills-Empresa-banda" aria-selected="true">
                                          ...
                                          <li class="nav-item bg-white">
                                            <a class="nav-link text-dark" id="pills-Usuario-banda-tab" data-toggle="pill" href="#pills-Usuario-banda" role="tab" aria-controls="pills-Usuario-banda" aria-selected="false">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                             $('#id_userbn').on('change', function () {
                                                    ...
                                                    $('#current_autobn').append(`<option value="" disabled selected>Prosesando..</option>`);
                                                 $.ajax({
                                                    type: 'GET',
                                                    url: 'crear/' + id,
                                                    success: function (response) {
                                                        ...
                                                        $('#current_autobn').empty();
                                                        $('#current_autobn').append(`<option value="" disabled selected>Seleccione Automovil</option>`);
                                  ...
                                  <!-- Select anidado Empresa-->
                                    <script>
                                                    ...
                                                    $('#current_autobn2').append(`<option value="" disabled selected>Prosesando..</option>`);
                                                    $.ajax({
                                                    type: 'GET',
                                                    ...
                                                    $('#current_autobn2').empty();
                                                    $('#current_autobn2').append(`<option value="" disabled selected>Seleccione Automovil</option>`);
                                                    response.forEach(element => {
