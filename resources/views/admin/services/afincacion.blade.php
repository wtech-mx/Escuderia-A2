                         ...
                         @csrf
                                  ...
                                  <div class="col-12 p-4">
                                        ...
                                        <input type="hidden" class="form-control" placeholder="servicio" style="border-radius: 0  10px 10px 0;" id="servicio" name="servicio" value="5">
                                         ...
                                         <hr>
                                         <label for="">
                                             <p class="text-white"><strong>Vida de afinaci&oacute;n en KM</strong></p>
                                         </label>
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Vida de afinacion en KM" style="border-radius: 0  10px 10px 0;" id="vida_llantas" name="vida_llantas" value="{{ old('vida_llantas') }}">
                                            </div>
