                       <form method="POST" action="{{ route('store_servicio.servicio') }}" enctype="multipart/form-data"
                           role="form">
                           @csrf
                           <div class="col-12">
                               ...
                               <div class="d-flex justify-content-center">.
                                   <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item bg-white">
                                        <a class="nav-link active" id="pills-Empresa-tab" data-toggle="pill" href="#pills-Empresa-otro" role="tab" aria-controls="pills-Empresa" aria-selected="true">
                                    ...
                                    <li class="nav-item bg-white">
                                        <a class="nav-link text-dark" id="pills-Usuario-tab" data-toggle="pill" href="#pills-Usuario-otro" role="tab" aria-controls="pills-Usuario" aria-selected="false">
                                  ...
                                  @if (auth()->user()->empresa == 1)
                                    <li class="nav-item bg-white">
                                        <a class="nav-link active" id="pills-Sector-tab" data-toggle="pill" href="#pills-Sector-otro" role="tab" aria-controls="pills-Sector" aria-selected="true">
                                            <img class="" src="{{ asset('img/icon/color/edificio-de-oficinas (3).png') }}" width="25px" >
                                            Sector
                                        </a>
                                    </li>
                               ...
                               <div class="tab-content p-4" id="pills-tabContent">
                                @if (auth()->user()->empresa == 0)
                                   <div class="tab-pane fade show active mr-4 ml-4" id="pills-Empresa-otro" role="tabpanel"
                                       ...
                                       <div class="input-group form-group">
                                           <div class="input-group-prepend ">
                                               <span class="input-group-text input-services">
                                                   <img class=""
                                                       src="{{ asset('img/icon/white/edificio-de-oficinas.png') }}"
                                                       width="25px">
                                               </span>
                                           </div>

                                           <select class="form-control empresa_otro" id="id_empresaot" name="id_empresaot"
                                       ...
                                       <div class="input-group form-group">
                                           <div class="input-group-prepend ">
                                               <span class="input-group-text input-services">
                                                   <img class="" src="{{ asset('img/icon/white/coche (7).png') }}"
                                                       width="25px">
                                               </span>
                                           </div>

                                           <select class="form-control" id="current_autoot2" name="current_autoot2"
                                               value="{{ old('current_autoot2') }}">
                                   ...
                                   <div class="tab-pane fade mr-4 ml-4" id="pills-Usuario-otro" role="tabpanel"
                                       aria-labelledby="pills-Usuario-otro-tab">
                                       ...
                                       <div class="input-group form-group">
                                           ...
                                           <select class="form-control formselect user_otro" id="id_userot" name="id_userot"
                                               value="{{ old('id_userot') }}">
                                       ...
                                       <div class="input-group form-group">
                                           ...
                                           <select class="form-control formselect" id="current_autoot"
                                               name="current_autoot" value="{{ old('current_autoot') }}">
                                               <option value="">Seleccione auto</option>
                                           </select>
                                       </div>
                                   </div>
                                @endif
                                   @if (auth()->user()->empresa == 1)
                                        <div class="tab-pane fade show active mr-4 ml-4" id="pills-Sector-otro" role="tabpanel" aria-labelledby="pills-Sector-tab">
                           ...
                           <div class="col-12 p-4">
                               ...
                               <input type="button" class="proveedor8" id="proveedor8" value="Agregar proveedor">
                               <div id="nuevo-form8"></div>
                                   ...
                                   <div class="col-12">
                                       ...
                                       <div class="input-group form-group">
                                           ...
                                           <input type="number" class="form-control" placeholder="Precio Venta"
                                               style="border-radius: 0  10px 10px 0;" id="precio" name="precio"
                                       ...
                                       <div class="input-group form-group">
                                           <div class="input-group-prepend">
                                               <span class="input-group-text input-services">
                                                   <img class=""
                                                       src="{{ asset('img/icon/white/calendario (1).png') }}"
                                                       width="25px">
                                               </span>
                                           </div>
                                           <input type="date" class="form-control" placeholder="MM/DD/YYY"
                                               style="border-radius: 0  10px 10px 0;" id='fecha_servicio'
                                               name="fecha_servicio">
                                       </div>
                                       ...
                                       <label for="">
                                           <p class="text-white"><strong>Descripci&oacute;n y/o informaci&oacute;n
                                                   adicional</strong></p>
                                       </label>
                                       ...
                                       <div class="input-group form-group">
                                           <div class="input-group-prepend ">
                                               <span class="input-group-text input-services">
                                                   <img class="" src="{{ asset('img/icon/white/contrato.png') }}"
                                                       width="25px">
                                               </span>
                                           </div>
                                           <input type="text" class="form-control" placeholder="Descripcion"
                                               style="border-radius: 0  10px 10px 0;" id="descripcion"
                               ...
                               <input type="hidden" class="form-control" placeholder="servicio"
                                   style="border-radius: 0  10px 10px 0;" id="servicio" name="servicio" value="8">
                               <hr>
                               <label for="">
                                   <p class="text-white"><strong>Vida de otro en KM</strong></p>
                               </label>
                               ...
                               <div class="input-group form-group">
                                   ...
                                   <input type="number" class="form-control" placeholder="vida otro"
                                       style="border-radius: 0  10px 10px 0;" id="vida_llantas" name="vida_llantas"
                                       value="{{ old('vida_llantas') }}">
                               </div>
                               ...
                               <div class="input-group form-group">
                                   <div class="input-group-prepend ">
                                       <span class="input-group-text input-services">
                                           <img class="" src="{{ asset('img/icon/white/velocimetro (2).png') }}"
                                               width="25px">
                                       </span>
                                   </div>
                                   <input type="number" class="form-control" placeholder="km actual"
                                       style="border-radius: 0  10px 10px 0;" id="km_actual" name="km_actual"
                                       value="{{ old('km_actual') }}">
                               </div>
                               ...
                               <div class="input-group form-group">
                                   ...
                                   <input type="number" class="form-control"
                                       placeholder="km estimado del próximo servicio"
                                       style="border-radius: 0  10px 10px 0;" id="km_estimado" name="km_estimado"
                                       value="{{ old('km_actual') }}">
                               </div>
                               ...
                               <div class="input-group form-group">
                                   ...
                                   <input type="date" class="form-control" placeholder="MM/DD/YYY"
                                       style="border-radius: 0  10px 10px 0;" id='start' name="start">
                               </div>
                           ...
                           <script>
                               $(document).ready(function() {
                                   $('#id_userot').on('change', function() {
                                       ...
                                       $('#current_autoot').append(
                                           `<option value="" disabled selected>Procesando..</option>`
                                           );
                                       $.ajax({
                                           type: 'GET',
                                           url: 'crear/' + id,
                                           success: function(response) {
                                               ...
                                               $('#current_autoot').empty();
                                               $('#current_autoot').append(
                                                   `<option value="" disabled selected>Seleccione Autom&oacute;vil</option>`
                                                   );
                                               response.forEach(element => {
                                                   $('#current_autoot').append(
                                                       `<option value="${element['id']}">${element['submarca']}</option>`
                                                       );
                                               });
                                           }
                                       });
                ...
                response.forEach(element => {
                    $('#current_autoot2').append(`<option value="${element['id']}">${element['submarca']}</option>`);
                           ...
                           <script>
                               ...
                               var contenedor8 = document.getElementById('nuevo-form8');
                               var contador = 0;

                               agregar8.addEventListener('click', function() {
                                   contador++;
                                   var _form8 = '<hr><label class="subtitle-form-servi">Proveedor ' + contador +
                                       '</label>' +
