                           ...
                           <div class="col-12 p-4">
                                        ...
                                        <div class="input-group form-group">
                                         ...
                                         <label for="">
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="vida otro" style="border-radius: 0  10px 10px 0;" id="vida_llantas" name="vida_llantas" value="{{ old('vida_llantas') }}">
                                            </div>
                                  ...
                                  <script>
                                    ...
                                    agregar8.addEventListener('click', function(){
                                        contador++;
                                        var _form8 = '<hr><label class="subtitle-form-servi">Proveedor '+ contador +'</label>' +
