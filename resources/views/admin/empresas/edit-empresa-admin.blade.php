...
<p style="display: none">{{$userId = Auth::id()}}</p>
                ...
                <div class="row bg-profile" style="z-index: 100000">
                    ...
                    <div class="col-12 p-3">
                        <p class="text-center">
                            @if ($empresa->img == NULL)
                            <img class="rounded-circle" src="{{ asset('img/icon/color/edificio-de-oficinas (3).png') }}" height="150px" width="150px">
                            @else
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="perfil" role="tabpanel" aria-labelledby="pills-perfil-tab">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input type="text" class="form-control"  id="name" name="name" value="{{$empresa->name}}" style="border-radius: 0  10px 10px 0;">
                                    </div>
                                ...
                                <div class="tab-pane fade" id="pills-Seguridad" role="tabpanel" aria-labelledby="pills-Seguridad-tab">
                                    ...
                                    <label for="">
                                        <p class="text-white mt-5"><strong>Confirmar Contraseña </strong></p>
                                    </label>
                                    ...
                                    <div class="col-12 text-center mt-5 mb-5" style="margin-bottom: 15rem !important;">
