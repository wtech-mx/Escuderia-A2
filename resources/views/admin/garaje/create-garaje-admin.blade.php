    ...
    <div class="row bg-blue" style="background-image: linear-gradient(to bottom, #00d62e, #2ce048, #43eb5f, #56f574, #68ff88); z-index: 0;">
        ...
        @if (Session::has('empresa'))
            <script>
                Swal.fire({
                    title: 'Exito!!',
                    html: 'Se ha agragado la <b>EMPRESA</b>, ' +
                        'Exitosamente',
                    ...
                    <div class="tab-pane fade show active" id="auto" role="tabpanel" aria-labelledby="pills-auto-tab">
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car" placeholder="Submarca" id="submarca"
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car" placeholder="Tipo" id="tipo"
                                    name="tipo" value="{{ old('tipo') }}">
                                @if ($errors->has('tipo'))
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car" placeholder="Transmisión"
                                    id="subtipo" name="subtipo" value="{{ old('subtipo') }}">
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="number" class="form-control input-edit-car" placeholder="kilometraje"
                                    id="kilometraje" name="kilometraje" value="{{ old('kilometraje') }}">
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="number" class="form-control input-edit-car" placeholder="YYYY" id="año"
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car" placeholder="Num Serie"
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car input-edit-car"
                                    placeholder="Num Placas" id="placas_viejas" name="placas_viejas">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control input-edit-car input-edit-car"
                                    placeholder="Num Placas" id="placas" name="placas" value="{{ old('placas') }}">
