...
?>
        ...
        <div class="row bg-down-image-border " >
                    ...
                    <form class="card-details" method="POST" action="{{route('update_admin.tarjeta-circulacion',$gasolina->id)}}" enctype="multipart/form-data" role="form">
                        @csrf
                        ...
                        @if ($gasolina->id_user == NULL)
                        <p class="text-center mb-5" style="color: #00d62e; font: normal normal bold 20px/27px Segoe UI;"><strong>{{$gasolina->UserEmpresa->name}} / {{$gasolina->Automovil->placas}}</strong></p>
                        @else
                        <p class="text-center mb-5" style="color: #00d62e; font: normal normal bold 20px/27px Segoe UI;"><strong>{{$gasolina->User->name}} / {{$gasolina->Automovil->placas}}</strong></p>
                           <input type="hidden" id="id_user" name="id_user" value="{{$gasolina->Automovil->id_user}}" readonly>
                           <input type="hidden" id="current_auto" name="current_auto" value="{{$gasolina->Automovil->id}}" readonly>
                        @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group form-group mb-5">
                                        ...
                                        <input type="text" class="form-control"  value="{{$gasolina->Automovil->Marca->nombre}}" readonly >
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group form-group mb-5">
                                        ...
                                        <input type="text" class="form-control"  value="{{$gasolina->Automovil->submarca}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group form-group mb-5">
                                        ...
                                        <input type="text" class="form-control"  id="num_placa" name="num_placa" value="{{$gasolina->Automovil->placas}}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group form-group mb-5">
                                        ...
                                        <input type="text" class="form-control"  id="num_placa" name="num_placa" value="{{$gasolina->num_placa}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-group form-group mb-5">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre de la tarjeta de Circulación" value="{{$gasolina->nombre}}" required>
                            </div>
                            ...
                            <div class="input-group form-group mb-5">
                                ...
                                <select class="form-control" id="tipo_placa" name="tipo_placa" required>
                                    <option value="{{$gasolina->tipo_placa}}" selected>{{$gasolina->tipo_placa}}</option>
                            ...
                            <div class="input-group form-group mb-5">
                                ...
                                <select class="form-control" id="lugar_expedicion" name="lugar_expedicion" required>
                                    <option value="{{$gasolina->lugar_expedicion}}" selected>{{$gasolina->lugar_expedicion}}</option>
                            ...
                            <div class="input-group form-group mb-5">
                                <div class="input-group-prepend">
                                 ...
                                 <input type="date" class="form-control" name="fecha_emision" id="fecha_emision" placeholder="MM/YYYY" value="{{$gasolina->fecha_emision}}">
                            </div>
                            ...
                            <div class="input-group form-group mb-5">
                                <div class="input-group-prepend">
                                 ...
                                 <input type="date" class="form-control" name="end" id="end" placeholder="MM/YYYY" value="{{$gasolina->end}}">
                            </div>
