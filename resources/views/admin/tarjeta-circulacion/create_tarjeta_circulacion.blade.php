...
<div class="row bg-blue" style="background-image: linear-gradient(to bottom, #24b6f7, #009fff, #0086ff, #0066ff, #243afc);">
                        ...
                        {{------------------------------------}}
                                    ...
                                    <script>
                                                    ...
                                                    $('#current_autotc').empty();
                                                    $('#current_autotc').append(`<option value="" disabled selected>Prosesando..</option>`);
                                                    $.ajax({
                                                    type: 'GET',
                                                    url: 'crear/',
                                                    ...
                                                    $('#current_autotc').empty();
                                                    $('#current_autotc').append(`<option value="" disabled selected>Seleccione Automovil2</option>`);
                                                    response.forEach(element => {
                                                        $('#current_autotc').append(`<option value="${element['id']}">${element['submarca']}</option>`);
                                                        });
                                                    }
                                                });
                                            });
