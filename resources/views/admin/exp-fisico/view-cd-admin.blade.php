...
<div class="row bg-down-blue " style="border-radius: 0 0 0 0; height: 95vh;">
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha agragado la <b>COMPROBANTE DE DOMICILIO</b>, ' +
                                'Exitosamente',
                              // text: 'Se ha agragado la "MARCA" Exitosamente',
                              imageUrl: '{{ asset('img/icon/color/comprobar.png') }}',
                              background: '#fff',
                              imageWidth: 150,
                              imageHeight: 150,
                              imageAlt: 'comprobar IMG',
                            })
                        </script>
                        @endif
                          ...
                          <div class="modal-dialog modal-sm modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <form method="POST" action="{{route('store_admin.view-cd-admin', $automovil->id)}}" enctype="multipart/form-data" role="form">
                                         @csrf
                                ...
                                <div class="col-12 mt-3">
                                          <div class=" custom-file mb-3">
                                            <input type="file" class="custom-file-input input-group-text image" id="domicilio" name="domicilio">
...
<script>
    $('#domicilio').ijaboCropTool({
        ...
        processUrl: '{{ route('store_admin.view-domicilio-admin', $automovil->id) }}',
