                        ...
                        @foreach($exp_reemplacamiento as $item)
                            ...
                            <div class="col-6">
                                <a  class="" data-toggle="modal" data-target="#modal-doc-{{$item->id}}">
                                        @if($texto == 'pdf')
                                            <p class="text-center">
                                                <iframe width="140" height="140" src="{{asset('exp-reemplacamiento/'.$item->reemplacamiento)}}" frameborder="0"></iframe>
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              <div class="col-11">
                                                  <p class="text-center">
                                                      <img class="" src="{{asset('exp-reemplacamiento/'.$item->reemplacamiento)}}" alt="{{$item->reemplacamiento}}" style="height: 300px!important;">
                                                  </p>
                                              </div>
                                              <div class="col-1">
                                                    <a  class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modalreemplacamiento{{$item->id}}">
                               ...
                               <form method="POST" action="{{route('store_admin.view-reemplacamiento-admin', $automovil->id)}}" enctype="multipart/form-data" role="form">
                                ...
                                <div class="col-12 mt-3">
                                    <div class=" custom-file mb-3">
                                        <input type="file" class="custom-file-input input-group-text image" id="reemplacamiento" name="reemplacamiento">
...
<script>
    $('#reemplacamiento').ijaboCropTool({
        ...
        processUrl: '{{ route('store_admin.view-reemplacamiento-admin', $automovil->id) }}',
