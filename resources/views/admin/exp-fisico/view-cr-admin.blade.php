...
<div class="row bg-down-blue " style="border-radius: 0 0 0 0; height: 95vh;">
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha eliminado su <b>Carta Responsiva</b>, ' +
                                'Exitosamente',
                              // text: 'Se ha agragado la "MARCA" Exitosamente',
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              <div class="col-11">
                                                  <p class="text-center">
                                                      <img class="" src="{{asset('exp-carta/'.$item->carta)}}" alt="{{$item->carta}}" style="height: 300px!important;">
                                                  </p>
                                              </div>
                                              <div class="col-1">
                                                    <a  class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modalcr{{$item->id}}">
                    ...
                    @else
                        ...
                        <div class="col-12 mt-5">
                            <p class="text-center">
                                 <button  class="btn " data-toggle="exampleModal" data-target="#exampleModal">
                                  ...
                                  <form method="POST" action="{{route('store_admin.view-cr-admin', $automovil->id)}}" enctype="multipart/form-data" role="form">
                                    ...
                                    <div class="col-12 mt-3">
                                          <div class=" custom-file mb-3">
                                            <input type="file" class="custom-file-input input-group-text image" id="carta" name="carta">
                                            <label class="custom-file-label">Elegir img...</label>
                                          </div>

                                        <p class="text-center">
                                            Agregar <br>
                                            Carta Responsiva/ Identificaci&oacute;n
...
<script>
    $('#carta').ijaboCropTool({
        ...
        processUrl: '{{ route('store_admin.view-carta-admin', $automovil->id) }}',
