...
<div class="row bg-down-blue " style="border-radius: 0 0 0 0; height: 95vh;">
                        ...
                        <script>
                            Swal.fire({
                              ...
                              imageWidth: 150,
                              imageHeight: 150,
                              imageAlt: 'licencia-de-conducir IMG',
                            })
                        </script>
                        @endif
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha eliminado su <b>Tarjeta de circulaci&oacute;n</b>, ' +
                                'Exitosamente',
                              // text: 'Se ha agragado la "MARCA" Exitosamente',
                    ...
                    @if ($exp_tc->count())
                        @foreach($exp_tc as $item)
                            @php
                                $texto= substr($item->tc, -3);
                            @endphp
                            <div class="col-6">
                                <a  class="" data-toggle="modal" data-target="#modal-doc-{{$item->id}}">
                                        @if($texto == 'pdf')
                                            <p class="text-center">
                                                <iframe width="140" height="140" src="{{asset('exp-tc/'.$item->tc)}}" frameborder="0"></iframe>
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              <div class="col-11">
                                                  <p class="text-center">
                                                      <img class="" src="{{asset('exp-tc/'.$item->tc)}}" alt="{{$item->tc}}" style="height: 300px!important;">
                                                  </p>
                                              </div>
                                              <div class="col-1">
                          ...
                          <div class="modal-dialog modal-sm modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <form method="POST" action="{{route('store_admin.view-tc-admin', $automovil->id)}}" enctype="multipart/form-data" role="form">
                               @csrf
...
<script>
    $('#tc').ijaboCropTool({
        ...
        processUrl: '{{ route('store_admin.view-tc-admin', $automovil->id) }}',
