                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              <div class="col-11">
                                                  <p class="text-center">
                                                      <img class="" src="{{asset('exp-tenencia/'.$item->tenencia)}}" alt="{{$item->tenencia}}" style="height: 300px!important;">
                                                  </p>
                                              </div>
                                              <div class="col-1">
                                                    <a  class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modaltenencias{{$item->id}}">
                               ...
                               <form method="POST" action="{{route('store_admin.view-tenencia-admin', $automovil->id)}}" enctype="multipart/form-data" role="form">
                                ...
                                <div class="col-12 mt-3">
                                    <div class=" custom-file mb-3">
                                        <input type="file" class="custom-file-input input-group-text image" id="tenencia" name="tenencia">
                                    </div>
...
<script>
    $('#tenencia').ijaboCropTool({
        ...
        processUrl: '{{ route('store_admin.view-tenencia-admin', $automovil->id) }}',
