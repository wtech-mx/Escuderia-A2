...
<div class="modal fade" id="modal-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <form method="POST" action="{{ route('destroy.notas', $item->id) }}" enctype="multipart/form-data" role="form">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h3 class="text-center p-2">Desea eliminar la nota de : {{ $item->User->name }} ? </h3>
