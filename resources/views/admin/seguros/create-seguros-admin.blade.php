...
{{--<div class="task-box text-center text-white">
  ...
  <div class="text-white" id="toolbar">
    <ul class="text-white" id="notifications">
    </ul>
...
// crear una referencia a la lista de notificaciones en la parte inferior de la aplicación;
                ...
                let newItem = [
                      { taskTitle: "", day: 0, month: "", year: 0, notified: "no" }
                    ];
                ...
                window.onload = function() {
                    ...
                    objectStore.openCursor().onsuccess = function(event) {
                      let cursor = event.target.result;
                        ...
                        if(cursor) {
                          ...
                          listItem.innerHTML = cursor.value.taskTitle + ' — ' + ', ' + cursor.value.month + ' ' + cursor.value.day + daySuffix + ' ' + cursor.value.year + '.';
                  ...
                  function addData(e) {
                    ...
                    if(title.value == '' || day.value == '' || month.value == '' || year.value == null) {
                      ...
                      let newItem = [
                        { taskTitle: title.value, day: day.value, month: month.value, year: year.value, notified: "no" }
                      ];
