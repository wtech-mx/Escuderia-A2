...
<div class="modal fade" id="modal-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <form method="POST" action="{{ route('destroy.sector', $item->id) }}" enctype="multipart/form-data" role="form">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Eliminar Sector </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h3 class="text-center p-2">Desea eliminar el Sector: {{ $item->sector }} ? </h3>
