    ...
    <div class="row bg-image">
                                ...
                                <div class="col-6  mt-4">
                                    <div class="card card-slide-garaje"
                                        ...
                                        <div class="card-body">
                                            @if ($item->img == null)
                                                <div class="col-6">
                                                    <img class="d-inline mb-2" src="{{ asset('img/icon/car.png') }}"
                                                        width="80px">
                                                </div>
                                            @else
                                                <div class="col-6">
                                                    <img class="d-inline mb-2" src="{{ asset('img-auto/' . $item->img) }}"
                                                        width="80px">
                                                </div>
                                            @endif
                                            <p class="card-text"><strong>{{ $item->submarca }}</strong></p>
                                            <p class="card-text" style="font-size: 12px"><strong>{{ $item->kilometraje }} KM
                                                    Recorridos</strong></p>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="col-6  mt-4">
                                    <a type="button" class="" data-toggle="modal"
                                        data-target="#modal-estatus-{{ $item->id }}">
                                        <div class="card card-slide-garaje">
                                            <div class="card-body">
                                                @if ($item->img == null)
                                                    <img class="d-inline mb-2" src="{{ asset('img/icon/car3.png') }}"
                                                        width="80px">
                                                @else
                                                    <img class="d-inline mb-2" src="{{ asset('img-auto/' . $item->img) }}"
                                                        width="80px">
                                                ...
                                                <p class="card-text" style="font-size: 12px">
                                                    <strong>{{ $item->kilometraje }} KM Recorridos</strong></p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="row overflow-hidden" style="height: 75vh;">
                    ...
                    <div class="col-12">
                        <p class="text-center title-car">
                            <img class="d-inline mb-2" src="{{ asset('img/icon/white/coche (7).png') }}"
                                alt="Icon documento" width="150px">

                        </p>
                        <p class="text-center  text-white">
                            <strong style="font: normal normal bold 20px/20px Segoe UI;">A&uacute;n no tienes Autos
                                registrados! </strong><br>
        ...
        @foreach ($carro as $item)
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/proteger.png') }}" alt="Icon documento"
                            width="50px">
                        <strong>Marca</strong>
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/coche (2).png') }}" alt="Icon documento"
                            width="50px">
                        <strong>Tipo</strong>
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/coche (3).png') }}" alt="Icon documento"
                            width="50px">
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/days.png') }}" alt="Icon documento"
                            width="50px">
                        <strong>Año</strong>
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;">
                    <div class="card-body text-center text-garaje">
                        ...
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/color-palette.png') }}"
                            alt="Icon documento" width="50px">
                        <strong>Color</strong>
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;margin-bottom: 8rem !important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/barcode.png') }}" alt="Icon documento"
                            width="50px">
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;margin-bottom: 8rem !important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/llantas.png') }}" alt="Icon documento"
                            width="50px">
            ...
            <div class="col-4 mb-3">
                <div class="card" style="border-radius: 15px;height: 160px!important;margin-bottom: 8rem !important;">
                    <div class="card-body text-center text-garaje">
                        <img class="d-inline mb-2" src="{{ asset('img/icon/black/placa.png') }}" alt="Icon documento"
                            width="50px">
