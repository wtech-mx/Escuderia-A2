...
<div class="row bg-down-blue " style="border-radius: 0 0 0 0; height: 100vh;">
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha guardado su <b>TENENCIA</b>, ' +
                                'Exitosamente',
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="col-1">
                                                    <a type="button" class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modaltenencias{{$item->id}}">
                          ...
                          <div class="modal-dialog modal-sm modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <form method="POST" action="{{route('store.exp-tenencias')}}" enctype="multipart/form-data" role="form">
                                         @csrf
