                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="col-1">
                                                    <a type="button" class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modalreemplacamiento{{$item->id}}">
                          ...
                          <div class="modal-dialog modal-sm modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <form method="POST" action="{{route('store.exp-reemplacamiento')}}" enctype="multipart/form-data" role="form">
                                         @csrf
