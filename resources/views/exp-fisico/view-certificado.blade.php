...
<div class="row bg-down-blue " style="border-radius: 0 0 0 0; height: 100vh;">
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha guardado su <b>CERTIFICADO</b>, ' +
                                'Exitosamente',
                        ...
                        <script>
                            Swal.fire({
                              title: 'Exito!!',
                              html:
                                'Se ha eliminado su <b>CERTIFICADO</b>, ' +
                                'Exitosamente',
                              // text: 'Se ha agragado la "MARCA" Exitosamente',
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="col-1">
                                                    <a type="button" class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modalcertificado{{$item->id}}">
