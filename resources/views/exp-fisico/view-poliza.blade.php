                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="col-1">
                                                    <a  class="btn btn-danger text-white p-2 mt-5 mb-5" data-toggle="modal" data-target="#modalpoliza{{$item->id}}">
