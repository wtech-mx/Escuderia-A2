...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('admin.layouts.app', function ($view) {
            ...
            $alert2 = Alertas::where('estatus', '=', 0)
                ->OrderBy('end', 'ASC')
                ->first();
            ...
            $seguro_alerta = Seguros::where('estatus', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $seguro_last_week = Seguros::where('estado_last_week', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $seguro_tomorrow = Seguros::where('estado_tomorrow', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();

            //Trae la alerta Tc
            $tc_alerta = TarjetaCirculacion::where('estatus', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $tc_last_week = TarjetaCirculacion::where('estado_last_week', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $tc_tomorrow = TarjetaCirculacion::where('estado_tomorrow', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();

            //Trae la alerta Verificacion
            $verificacion = Verificacion::where('estatus', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $verificacion_last_week = Verificacion::where('estado_last_week', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $verificacion_tomorrow = Verificacion::where('estado_tomorrow', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();

            //Trae la alerta Verificacion_Segunda
            $verificacion_segunda = VerificacionSegunda::where('estatus', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $verificacion_segunda_last_week = VerificacionSegunda::where('estado_last_week', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $verificacion_segunda_tomorrow = VerificacionSegunda::where('estado_tomorrow', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();


            //Trae la alerta Verificacion_Segunda
            $servicios = Llantas::where('estatus', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $servicios_last_week = Llantas::where('estado_last_week', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
            $servicios_tomorrow = Llantas::where('estado_tomorrow', '=', 0)->where('check', '=', 0)->where('id_empresa', '=', NULL)->OrderBy('end', 'ASC')->first();
